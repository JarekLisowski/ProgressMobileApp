...
public partial class PdPodmiot
{
    ...
    public bool PdDokMagDyspWylaczKasowanie { get; set; }

    public string PdEmailWystawca { get; set; } = null!;

    public int PdRodzajPowiazaniaWystawcy { get; set; }

    public bool PdDocumentsPortalLastSeenActive { get; set; }
}
