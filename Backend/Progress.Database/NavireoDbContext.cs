...
public partial class NavireoDbContext : DbContext
{
  ...
  public virtual DbSet<IfxGrupaCechy> IfxGrupaCechy { get; set; }
  ...
  protected override void OnModelCreating(ModelBuilder modelBuilder)
  {
    ...
    modelBuilder.Entity<IfxGrupaCechy>(entity =>
    {
      entity.ToTable("IFx_GrupaCechy");
      entity.HasKey("GrId", "CechaId");
    });
